package com.spread.api.service;
...
import com.spread.api.util.JpushConfig;
...
public class JpushService {
     ...
     * @return PushResult
     */
    public PushResult sendPushWithCustom(String title, String content, Map<String, String> extrasMap, String... alias) {
        ClientConfig clientConfig = ClientConfig.getInstance();
        clientConfig.setTimeToLive(Long.valueOf(jpushConfig.getLiveTime()));
    ...
    public void sendPushWithCallback(String title, String content, Map<String, String> extrasMap, String... alias) {
        ...
        String authCode = ServiceHelper.getBasicAuthorization(jpushConfig.getMasterSecret(), jpushConfig.getAppkey());
        NettyHttpClient client = new NettyHttpClient(authCode, null, clientConfig);
        try {
